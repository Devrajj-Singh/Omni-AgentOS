...
export function MessageList({ messages, onSuggestionClick, onRegenerate, onEditSubmit }: MessageListProps): JSX.Element {
    ...
    <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden">
      ...
      {showScrollButton && (
        <button
          ...
          className="absolute bottom-4 right-4 z-20 flex h-8 w-8 items-center justify-center rounded-full border border-border-default bg-bg-raised text-text-secondary shadow-lg transition-all hover:border-accent/40 hover:bg-bg-surface hover:text-text-primary"
